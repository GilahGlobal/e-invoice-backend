...
func GetQueryRequest(client HTTPClient, config RequestConfig, response interface{}, query entities.PaginationQuery) (*Response, error) {
	req, err := http.NewRequest(http.MethodGet, config.URL, nil)
	if err != nil {
		return nil, err
	}
...
func GetQueryPullRequest(client HTTPClient, config RequestConfig, response interface{}, query entities.PullDataQuery) (*Response, error) {
	req, err := http.NewRequest(http.MethodGet, config.URL, nil)
	if err != nil {
		return nil, err
	}
