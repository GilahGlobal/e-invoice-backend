...
func ValidateInvoice(req firs_models.UploadInvoiceRequestDto, IsSandbox bool) (*utility.Response, error) {
...
func SignInvoice(req firs_models.UploadInvoiceRequestDto, IsSandbox bool) (*utility.Response, error) {
