// Package frontend Code generated by swaggo/swag. DO NOT EDIT
package frontend
...
const docTemplatefrontend = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.AdminLoginRequestDto"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/admin.AdminLoginResponseDto"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/firs_models.BulkUpdateInvoiceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "entities.DailyInvoiceStatsDto": {
            ...
            "properties": {
                "currencies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.CurrencyStatsDto"
                    }
                },
                "date": {
                    "type": "string",
        ...
        "firs_models.BulkUpdateFailedItem": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "firs_models.BulkUpdateInvoiceItem": {
            "type": "object",
            "required": [
                "irn",
                "payment_status"
        ...
        "firs_models.BulkUpdateInvoiceRequest": {
            "type": "object",
            "required": [
                "invoices"
            ],
            "properties": {
                "invoices": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/firs_models.BulkUpdateInvoiceItem"
                    }
                }
            }
        },
        "firs_models.BulkUpdateInvoiceResponse": {
            "type": "object",
            "properties": {
                "failed": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/firs_models.BulkUpdateFailedItem"
                    }
                },
                "successful": {
                    "type": "array",
        ...
        "invoice.BulkUpdateInvoiceResponseDto": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/firs_models.BulkUpdateInvoiceResponse"
                },
                "error": {},
                "extra": {},
                "message": {
...
var SwaggerInfofrontend = &swag.Spec{
	...
	Description:      "Complete API documentation for Nexar.",
